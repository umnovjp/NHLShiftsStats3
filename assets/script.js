    ...
    .then(function (data) {console.log('I am in schedule then');
      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
          ...
          else if (finalLineup2[h+4].length===9) {for (j=0;j<tempArray3[i-2];j++){if (finalLineup2[h][i].includes(j)){}
          else finalLineup2[h+2][i].push(j)}} 
          else if (finalLineup2[h+4].length===6) {console.log('Two lines'); linesArray4 = [[],[]]
        for (j=3*h;j<3+3*h;j++) {for (k=0;k<linesArray[j].length/5;k++) {
          if((finalLineup2[h][i].includes(linesArray[j][5*k+2]))||(finalLineup2[h][i].includes(linesArray[j][5*k+3]))||(finalLineup2[h][i].includes(linesArray[j][5*k+4]))) {}
          else {linesArray4[h].push(linesArray[j][5*k], linesArray[j][5*k+1], linesArray[j][5*k+2], linesArray[j][5*k+3], linesArray[j][5*k+4])}
          
          tempIndex = linesArray4[h].indexOf(Math.max(...linesArray4[h])); tempIndex2 = tempIndex%(linesArray4[h].length/3);
          console.log(linesArray4, Math.max(...linesArray4[h]), tempIndex, tempIndex2);
          finalLineup2[h+2][i].push(linesArray4[h][tempIndex+2], linesArray4[h][tempIndex+3], linesArray4[h][tempIndex+4]);
          // line 33 to copy here 
        }}
        }}} // h loop end
            console.log('finalLineup2', finalLineup2); 
                  ...
                  for (k=0;k<shiftsLine[3+i].length/2;k++) { lineVsLineTime=lineVsLineTime+shiftsLine[3+i][2*k+1]-shiftsLine[3+i][2*k];
                    ...
                    if (finalLineup[3]>=12) { secondLineTime3.innerHTML=lineByLine(0,1,0)[0][0]+' '+lineByLine(0,1,0)[0][1]+' '+lineByLine(0,1,1)[0][0]+' '+lineByLine(0,1,1)[0][1]+' '+lineByLine(0,1,2)[0][0]+' '+lineByLine(0,1,2)[0][1]+' '+lineByLine(0,1,3)[0][0]+' '+lineByLine(0,1,3)[0][1]+' '+'<br>'+lineByLine(0,1,0)[0][2]+' '+lineByLine(0,1,0)[0][3]+' '+lineByLine(0,1,1)[0][2]+' '+lineByLine(0,1,1)[0][3]+' '+
                    ...
                    if (finalLineup[3]>=12) {lineByLine37.innerHTML=lineByLine(0,1,3)[0][0]+' '+lineByLine(0,1,3)[0][1]+'<br>'+lineByLine(0,1,3)[0][2]+' '+lineByLine(0,1,3)[0][3]+' '+'<br>'+lineByLine(0,1,3)[0][4]+' '+lineByLine(0,1,3)[0][5]}
                    ...
                    if (finalLineup[3]>=12) {lineByLine47.innerHTML=lineByLine(0,2,3)[0][0]+' '+lineByLine(0,2,3)[0][1]+'<br>'+lineByLine(0,2,3)[0][2]+' '+lineByLine(0,2,3)[0][3]+' '+'<br>'+lineByLine(0,2,3)[0][4]+' '+lineByLine(0,2,3)[0][5]+' '}
                    ...
                    if (finalLineup[3]>=12) {fourthLineTime3.innerHTML=lineByLine(0,3,0)[0][0]+' '+lineByLine(0,3,0)[0][1]+' '+lineByLine(0,3,1)[0][0]+' '+lineByLine(0,3,1)[0][1]+' '+lineByLine(0,3,2)[0][0]+' '+lineByLine(0,3,2)[0][1]+' '+lineByLine(0,3,3)[0][0]+' '+lineByLine(0,3,3)[0][1]+' '+'<br>'+lineByLine(0,3,0)[0][2]+' '+lineByLine(0,3,0)[0][3]+' '+lineByLine(0,3,1)[0][2]+' '+lineByLine(0,3,1)[0][3]+' '+
                    ...
                    if (finalLineup[3]>=12) {lineByLine57.innerHTML=lineByLine(0,3,3)[0][0]+' '+lineByLine(0,3,3)[0][1]+'<br>'+lineByLine(0,3,3)[0][2]+' '+lineByLine(0,3,3)[0][3]+' '+'<br>'+lineByLine(0,3,3)[0][4]+' '+lineByLine(0,3,3)[0][5]+' '}
                  }
