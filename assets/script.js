      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                    ...
                    // shiftsLine structure: index 0,1,2 is for two players out of line for h team, 3,4,5 is entire line together for this line; 6,7,8 is for two players then 9,10,11 for entire line of 1-h team 
                       function lineByLine(h,f,j) { shiftsLine=[]; for (i=0;i<16;i++) {shiftsLine.push([])}
                    ...
                    for (l=0;l<shiftsLine[6+i].length/2;l++) { for (m=0;m<fArray[1-h][finalLineup[3-h][3*j+2]][i].length/2;m++) {if ((fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m]>=shiftsLine[6+i][2*l]) && (fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m]<=shiftsLine[6+i][2*l+1]))
                      {if (fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m+1]>=shiftsLine[6+i][2*l+1]) {shiftsLine[6+i+3].push(fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m], shiftsLine[6+i][2*l+1]) }
                        else { shiftsLine[6+i+3].push(fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m], fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m+1]) }}
                          ...
                          if (fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m+1]>=shiftsLine[6+i][2*l+1]) { shiftsLine[6+i+3].push(shiftsLine[6+i][2*l], shiftsLine[6+i][2*l+1]) }
                          else {shiftsLine[6+i+3].push(shiftsLine[6+i][2*l], fArray[1-h][finalLineup[3-h][3*j+2]][i][2*m+1])}}
                  ...
                  for (k=0;k<shiftsLine[3+i].length/2;k++) { lineVsLineTime=lineVsLineTime+shiftsLine[3+i][2*k+1]-shiftsLine[3+i][2*k];
                    ...
                    shiftsLine[14].push(lineVsLineTime, lineVsLineShifts)
                  lineVsLineTime=0; lineVsLineShifts=0;
                  for (k=0;k<shiftsLine[9+i].length/2;k++) { lineVsLineTime=lineVsLineTime+shiftsLine[9+i][2*k+1]-shiftsLine[9+i][2*k];
                    if (shiftsLine[9+i][2*k+1]-shiftsLine[9+i][2*k]>=10) {lineVsLineShifts=lineVsLineShifts+1}}
                    shiftsLine[15].push(lineVsLineTime, lineVsLineShifts)
                  } // end i loop
                    ...
                    firstLineTime3.innerHTML=lineByLine(0,0,0)[0]+' '+lineByLine(0,0,0)[1]+' '+lineByLine(0,0,1)[0]+' '+lineByLine(0,0,1)[1]+' '+lineByLine(0,0,2)[0]+' '+lineByLine(0,0,2)[1]+' '+lineByLine(0,0,3)[0]+' '+lineByLine(0,0,3)[1]+' '+'<br>'+lineByLine(0,0,0)[2]+' '+lineByLine(0,0,0)[3]+' '+lineByLine(0,0,1)[2]+' '+lineByLine(0,0,1)[3]+' '+
                    lineByLine(0,0,2)[2]+' '+lineByLine(0,0,2)[3]+' '+lineByLine(0,0,3)[2]+' '+lineByLine(0,0,3)[3]+' '+'<br>'+lineByLine(0,0,0)[4]+' '+lineByLine(0,0,0)[5]+' '+lineByLine(0,0,1)[4]+' '+lineByLine(0,0,1)[5]+' '+lineByLine(0,0,2)[4]+' '+lineByLine(0,0,2)[5]+' '+lineByLine(0,0,3)[4]+' '+lineByLine(0,0,3)[5]+' ';
                    ...
                    lineByLine24.innerHTML=lineByLine(0,0,0)[0]+' '+lineByLine(0,0,0)[1]+' '+lineByLine(1,0,0)[0]+' '+lineByLine(1,0,0)[1]+' '+'<br>'+lineByLine(0,0,0)[2]+' '+lineByLine(0,0,0)[3]+' '+lineByLine(1,0,0)[2]+' '+lineByLine(1,0,0)[3]+' '+'<br>'+lineByLine(0,0,0)[4]+' '+lineByLine(0,0,0)[5]+' '+lineByLine(1,0,0)[4]+' '+lineByLine(1,0,0)[5]+' ';
                    lineByLine25.innerHTML=lineByLine(0,0,1)[0]+' '+lineByLine(0,0,1)[1]+' '+lineByLine(1,1,0)[0]+' '+lineByLine(1,1,0)[1]+' '+'<br>'+lineByLine(0,0,1)[2]+' '+lineByLine(0,0,1)[3]+' '+lineByLine(1,1,0)[2]+' '+lineByLine(1,1,0)[3]+' '+'<br>'+lineByLine(0,0,1)[4]+' '+lineByLine(0,0,1)[5]+' '+lineByLine(1,1,0)[4]+' '+lineByLine(1,1,0)[5]+' ';
                    lineByLine26.innerHTML=lineByLine(0,0,2)[0]+' '+lineByLine(0,0,2)[1]+' '+lineByLine(1,2,0)[0]+' '+lineByLine(1,2,0)[1]+' '+'<br>'+lineByLine(0,0,2)[2]+' '+lineByLine(0,0,2)[3]+' '+lineByLine(1,2,0)[2]+' '+lineByLine(1,2,0)[3]+' '+'<br>'+lineByLine(0,0,2)[4]+' '+lineByLine(0,0,2)[5]+' '+lineByLine(1,2,0)[4]+' '+lineByLine(1,2,0)[5]+' ';
                    lineByLine27.innerHTML=lineByLine(0,0,3)[0]+' '+lineByLine(0,0,3)[1]+' '+lineByLine(1,3,0)[0]+' '+lineByLine(1,3,0)[1]+' '+'<br>'+lineByLine(0,0,3)[2]+' '+lineByLine(0,0,3)[3]+' '+lineByLine(1,3,0)[2]+' '+lineByLine(1,3,0)[3]+' '+'<br>'+lineByLine(0,0,3)[4]+' '+lineByLine(0,0,3)[5]+' '+lineByLine(1,3,0)[4]+' '+lineByLine(1,3,0)[5]+' ';
                    ...
                    secondLineTime3.innerHTML=lineByLine(0,1,0)[0]+' '+lineByLine(0,1,0)[1]+' '+lineByLine(0,1,1)[0]+' '+lineByLine(0,1,1)[1]+' '+lineByLine(0,1,2)[0]+' '+lineByLine(0,1,2)[1]+' '+lineByLine(0,1,3)[0]+' '+lineByLine(0,1,3)[1]+' '+'<br>'+lineByLine(0,1,0)[2]+' '+lineByLine(0,1,0)[3]+' '+lineByLine(0,1,1)[2]+' '+lineByLine(0,1,1)[3]+' '+
                    lineByLine(0,1,2)[2]+' '+lineByLine(0,1,2)[3]+' '+lineByLine(0,1,3)[2]+' '+lineByLine(0,1,3)[3]+' '+'<br>'+lineByLine(0,1,0)[4]+' '+lineByLine(0,1,0)[5]+' '+lineByLine(0,1,1)[4]+' '+lineByLine(0,1,1)[5]+' '+lineByLine(0,1,2)[4]+' '+lineByLine(0,1,2)[5]+' '+lineByLine(0,1,3)[4]+' '+lineByLine(0,1,3)[5]+' ';
                    ...
                    lineByLine31.innerHTML=linesArray[0][5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])]+'<br>'+linesArray[1][5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])]+'<br>'+linesArray[2][5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])];
                    lineByLine32.innerHTML=linesArray[0][1+5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])]+'<br>'+linesArray[1][1+5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])]+'<br>'+linesArray[2][1+5*lineNumber(0,finalLineup[2][3],finalLineup[2][4],finalLineup[2][5])];
                    lineByLine34.innerHTML=lineByLine(0,1,0)[0]+' '+lineByLine(0,1,0)[1]+' '+lineByLine(1,0,1)[0]+' '+lineByLine(1,0,1)[1]+' '+'<br>'+lineByLine(0,1,0)[2]+' '+lineByLine(0,1,0)[3]+' '+lineByLine(1,0,1)[2]+' '+lineByLine(1,0,1)[3]+' '+'<br>'+lineByLine(0,1,0)[4]+' '+lineByLine(0,1,0)[5]+' '+lineByLine(1,0,1)[4]+' '+lineByLine(1,0,1)[5]+' ';
                    lineByLine35.innerHTML=lineByLine(0,1,1)[0]+' '+lineByLine(0,1,1)[1]+' '+lineByLine(1,1,1)[0]+' '+lineByLine(1,1,1)[1]+' '+'<br>'+lineByLine(0,1,1)[2]+' '+lineByLine(0,1,1)[3]+' '+lineByLine(1,1,1)[2]+' '+lineByLine(1,1,1)[3]+' '+'<br>'+lineByLine(0,1,1)[4]+' '+lineByLine(0,1,1)[5]+' '+lineByLine(1,1,1)[4]+' '+lineByLine(1,1,1)[5]+' ';
                    lineByLine36.innerHTML=lineByLine(0,1,2)[0]+' '+lineByLine(0,1,2)[1]+' '+lineByLine(1,1,2)[0]+' '+lineByLine(1,1,2)[1]+' '+'<br>'+lineByLine(0,1,2)[2]+' '+lineByLine(0,1,2)[3]+' '+lineByLine(1,1,2)[2]+' '+lineByLine(1,1,2)[3]+' '+'<br>'+lineByLine(0,1,2)[4]+' '+lineByLine(0,1,2)[5]+' '+lineByLine(1,1,2)[4]+' '+lineByLine(1,1,2)[5]+' ';
                    lineByLine37.innerHTML=lineByLine(0,1,3)[0]+' '+lineByLine(0,1,3)[1]+' '+lineByLine(1,1,3)[0]+' '+lineByLine(1,1,3)[1]+' '+'<br>'+lineByLine(0,1,3)[2]+' '+lineByLine(0,1,3)[3]+' '+lineByLine(1,1,3)[2]+' '+lineByLine(1,1,3)[3]+' '+'<br>'+lineByLine(0,1,3)[4]+' '+lineByLine(0,1,3)[5]+' '+lineByLine(1,1,3)[4]+' '+lineByLine(1,1,3)[5]+' ';
                    ...
                    thirdLineTime3.innerHTML=lineByLine(0,2,0)[0]+' '+lineByLine(0,2,0)[1]+' '+lineByLine(0,2,1)[0]+' '+lineByLine(0,2,1)[1]+' '+lineByLine(0,2,2)[0]+' '+lineByLine(0,2,2)[1]+' '+lineByLine(0,2,3)[0]+' '+lineByLine(0,2,3)[1]+' '+'<br>'+lineByLine(0,2,0)[2]+' '+lineByLine(0,2,0)[3]+' '+lineByLine(0,2,1)[2]+' '+lineByLine(0,2,1)[3]+' '+
                    lineByLine(0,2,2)[2]+' '+lineByLine(0,2,2)[3]+' '+lineByLine(0,2,3)[2]+' '+lineByLine(0,2,3)[3]+' '+'<br>'+lineByLine(0,2,0)[4]+' '+lineByLine(0,2,0)[5]+' '+lineByLine(0,2,1)[4]+' '+lineByLine(0,2,1)[5]+' '+lineByLine(0,2,2)[4]+' '+lineByLine(0,2,2)[5]+' '+lineByLine(0,2,3)[4]+' '+lineByLine(0,2,3)[5]+' ';
                    ...
                    lineByLine41.innerHTML=linesArray[0][5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])]+'<br>'+linesArray[1][5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])]+'<br>'+linesArray[2][5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])];
                    lineByLine42.innerHTML=linesArray[0][1+5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])]+'<br>'+linesArray[1][1+5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])]+'<br>'+linesArray[2][1+5*lineNumber(0,finalLineup[2][6],finalLineup[2][7],finalLineup[2][8])];
                    lineByLine44.innerHTML=lineByLine(0,2,0)[0]+' '+lineByLine(0,2,0)[1]+' '+lineByLine(1,2,0)[0]+' '+lineByLine(1,2,0)[1]+' '+'<br>'+lineByLine(0,2,0)[2]+' '+lineByLine(0,2,0)[3]+' '+lineByLine(1,2,0)[2]+' '+lineByLine(1,2,0)[3]+' '+'<br>'+lineByLine(0,2,0)[4]+' '+lineByLine(0,2,0)[5]+' '+lineByLine(1,2,0)[4]+' '+lineByLine(1,2,0)[5]+' ';
                    lineByLine45.innerHTML=lineByLine(0,2,1)[0]+' '+lineByLine(0,2,1)[1]+' '+lineByLine(1,2,1)[0]+' '+lineByLine(1,2,1)[1]+' '+'<br>'+lineByLine(0,2,1)[2]+' '+lineByLine(0,2,1)[3]+' '+lineByLine(1,2,1)[2]+' '+lineByLine(1,2,1)[3]+' '+'<br>'+lineByLine(0,2,1)[4]+' '+lineByLine(0,2,1)[5]+' '+lineByLine(1,2,1)[4]+' '+lineByLine(1,2,1)[5]+' ';
                    lineByLine46.innerHTML=lineByLine(0,2,2)[0]+' '+lineByLine(0,2,2)[1]+' '+lineByLine(1,2,2)[0]+' '+lineByLine(1,2,2)[1]+' '+'<br>'+lineByLine(0,2,2)[2]+' '+lineByLine(0,2,2)[3]+' '+lineByLine(1,2,2)[2]+' '+lineByLine(1,2,2)[3]+' '+'<br>'+lineByLine(0,2,2)[4]+' '+lineByLine(0,2,2)[5]+' '+lineByLine(1,2,2)[4]+' '+lineByLine(1,2,2)[5]+' ';
                    lineByLine47.innerHTML=lineByLine(0,2,3)[0]+' '+lineByLine(0,2,3)[1]+' '+lineByLine(1,2,3)[0]+' '+lineByLine(1,2,3)[1]+' '+'<br>'+lineByLine(0,2,3)[2]+' '+lineByLine(0,2,3)[3]+' '+lineByLine(1,2,3)[2]+' '+lineByLine(1,2,3)[3]+' '+'<br>'+lineByLine(0,2,3)[4]+' '+lineByLine(0,2,3)[5]+' '+lineByLine(1,2,3)[4]+' '+lineByLine(1,2,3)[5]+' ';
                    ...
                    fourthLineTime3.innerHTML=lineByLine(0,3,0)[0]+' '+lineByLine(0,3,0)[1]+' '+lineByLine(0,3,1)[0]+' '+lineByLine(0,3,1)[1]+' '+lineByLine(0,3,2)[0]+' '+lineByLine(0,3,2)[1]+' '+lineByLine(0,3,3)[0]+' '+lineByLine(0,3,3)[1]+' '+'<br>'+lineByLine(0,3,0)[2]+' '+lineByLine(0,3,0)[3]+' '+lineByLine(0,3,1)[2]+' '+lineByLine(0,3,1)[3]+' '+
                    lineByLine(0,3,2)[2]+' '+lineByLine(0,3,2)[3]+' '+lineByLine(0,3,3)[2]+' '+lineByLine(0,3,3)[3]+' '+'<br>'+lineByLine(0,3,0)[4]+' '+lineByLine(0,3,0)[5]+' '+lineByLine(0,3,1)[4]+' '+lineByLine(0,3,1)[5]+' '+lineByLine(0,3,2)[4]+' '+lineByLine(0,3,2)[5]+' '+lineByLine(0,3,3)[4]+' '+lineByLine(0,3,3)[5]+' ';
                    ...
                    lineByLine51.innerHTML=linesArray[0][5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])]+'<br>'+linesArray[1][5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])]+'<br>'+linesArray[2][5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])];
                    lineByLine52.innerHTML=linesArray[0][1+5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])]+'<br>'+linesArray[1][1+5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])]+'<br>'+linesArray[2][1+5*lineNumber(0,finalLineup[2][9],finalLineup[2][10],finalLineup[2][11])];
                    lineByLine54.innerHTML=lineByLine(0,3,0)[0]+' '+lineByLine(0,3,0)[1]+' '+lineByLine(1,3,0)[0]+' '+lineByLine(1,3,0)[1]+' '+'<br>'+lineByLine(0,3,0)[2]+' '+lineByLine(0,3,0)[3]+' '+lineByLine(1,3,0)[2]+' '+lineByLine(1,3,0)[3]+' '+'<br>'+lineByLine(0,3,0)[4]+' '+lineByLine(0,3,0)[5]+' '+lineByLine(1,3,0)[4]+' '+lineByLine(1,3,0)[5]+' ';
                    lineByLine55.innerHTML=lineByLine(0,3,1)[0]+' '+lineByLine(0,3,1)[1]+' '+lineByLine(1,3,1)[0]+' '+lineByLine(1,3,1)[1]+' '+'<br>'+lineByLine(0,3,1)[2]+' '+lineByLine(0,3,1)[3]+' '+lineByLine(1,3,1)[2]+' '+lineByLine(1,3,1)[3]+' '+'<br>'+lineByLine(0,3,1)[4]+' '+lineByLine(0,3,1)[5]+' '+lineByLine(1,3,1)[4]+' '+lineByLine(1,3,1)[5]+' ';
                    lineByLine56.innerHTML=lineByLine(0,3,2)[0]+' '+lineByLine(0,3,2)[1]+' '+lineByLine(1,3,2)[0]+' '+lineByLine(1,3,2)[1]+' '+'<br>'+lineByLine(0,3,2)[2]+' '+lineByLine(0,3,2)[3]+' '+lineByLine(1,3,2)[2]+' '+lineByLine(1,3,2)[3]+' '+'<br>'+lineByLine(0,3,2)[4]+' '+lineByLine(0,3,2)[5]+' '+lineByLine(1,3,2)[4]+' '+lineByLine(1,3,2)[5]+' ';
                    lineByLine57.innerHTML=lineByLine(0,3,3)[0]+' '+lineByLine(0,3,3)[1]+' '+lineByLine(1,3,3)[0]+' '+lineByLine(1,3,3)[1]+' '+'<br>'+lineByLine(0,3,3)[2]+' '+lineByLine(0,3,3)[3]+' '+lineByLine(1,3,3)[2]+' '+lineByLine(1,3,3)[3]+' '+'<br>'+lineByLine(0,3,3)[4]+' '+lineByLine(0,3,3)[5]+' '+lineByLine(1,3,3)[4]+' '+lineByLine(1,3,3)[5]+' ';
                  }
                    ...
                    firstLineTime3Away.innerHTML=lineByLine(1,0,0)[0]+' '+lineByLine(1,0,0)[1]+' '+lineByLine(1,0,1)[0]+' '+lineByLine(1,0,1)[1]+' '+lineByLine(1,0,2)[0]+' '+lineByLine(1,0,2)[1]+' '+lineByLine(1,0,3)[0]+' '+lineByLine(1,0,3)[1]+' '+'<br>'+lineByLine(1,0,0)[2]+' '+lineByLine(1,0,0)[3]+' '+lineByLine(1,0,1)[2]+' '+lineByLine(1,0,1)[3]+' '+
                    lineByLine(1,0,2)[2]+' '+lineByLine(1,0,2)[3]+' '+lineByLine(1,0,3)[2]+' '+lineByLine(1,0,3)[3]+' '+'<br>'+lineByLine(1,0,0)[4]+' '+lineByLine(1,0,0)[5]+' '+lineByLine(1,0,1)[4]+' '+lineByLine(1,0,1)[5]+' '+lineByLine(1,0,2)[4]+' '+lineByLine(1,0,2)[5]+' '+lineByLine(1,0,3)[4]+' '+lineByLine(1,0,3)[5]+' ';
                    ...
                    lineByLine14.innerHTML=linesArray[3][5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])]+' '+linesArray[3][1+5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])]+'<br>'+linesArray[4][5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])]+' '+linesArray[4][1+5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])]+
                    '<br>'+linesArray[5][5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])]+' '+linesArray[5][1+5*lineNumber(1,finalLineup[3][0],finalLineup[3][1],finalLineup[3][2])];
                    ...
                    secondLineTime3Away.innerHTML=lineByLine(1,1,0)[0]+'s '+lineByLine(1,1,0)[1]+'sh/ '+lineByLine(1,1,1)[0]+'s '+lineByLine(1,1,1)[1]+'sh/ '+lineByLine(1,1,2)[0]+'s '+lineByLine(1,1,2)[1]+'sh/ '+lineByLine(1,1,3)[0]+'s '+lineByLine(1,1,3)[1]+'sh/ '+'<br>'+lineByLine(1,1,0)[2]+'s '+lineByLine(1,1,0)[3]+'sh/ '+lineByLine(1,1,1)[2]+'s '+lineByLine(1,1,1)[3]+'sh/ '+
                    lineByLine(1,1,2)[2]+'s '+lineByLine(1,1,2)[3]+'sh/ '+lineByLine(1,1,3)[2]+'s '+lineByLine(1,1,3)[3]+'sh/ '+'<br>'+lineByLine(1,1,0)[4]+'s '+lineByLine(1,1,0)[5]+'sh/ '+lineByLine(1,1,1)[4]+'s '+lineByLine(1,1,1)[5]+'sh/ '+lineByLine(1,1,2)[4]+'s '+lineByLine(1,1,2)[5]+'sh/ '+lineByLine(1,1,3)[4]+'s '+lineByLine(1,1,3)[5]+'sh/ ';
                    ...
                    lineByLine15.innerHTML=linesArray[3][5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])]+' '+linesArray[3][1+5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])]+'<br>'+linesArray[4][5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])]+' '+linesArray[4][1+5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])]+
                    '<br>'+linesArray[5][5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])]+' '+linesArray[5][1+5*lineNumber(1,finalLineup[3][3],finalLineup[3][4],finalLineup[3][5])];
                    ...
                    thirdLineTime3Away.innerHTML=lineByLine(1,2,0)[0]+'s '+lineByLine(1,2,0)[1]+'sh/ '+lineByLine(1,2,1)[0]+'s '+lineByLine(1,2,1)[1]+'sh/ '+lineByLine(1,2,2)[0]+'s '+lineByLine(1,2,2)[1]+'sh/ '+lineByLine(1,2,3)[0]+'s '+lineByLine(1,2,3)[1]+'sh/ '+'<br>'+lineByLine(1,2,0)[2]+'s '+lineByLine(1,2,0)[3]+'sh/ '+lineByLine(1,2,1)[2]+'s '+lineByLine(1,2,1)[3]+'sh/ '+
                    lineByLine(1,2,2)[2]+'s '+lineByLine(1,2,2)[3]+'sh/ '+lineByLine(1,2,3)[2]+'s '+lineByLine(1,2,3)[3]+'sh/ '+'<br>'+lineByLine(1,2,0)[4]+'s '+lineByLine(1,2,0)[5]+'sh/ '+lineByLine(1,2,1)[4]+'s '+lineByLine(1,2,1)[5]+'sh/ '+lineByLine(1,2,2)[4]+'s '+lineByLine(1,2,2)[5]+'sh/ '+lineByLine(1,2,3)[4]+'s '+lineByLine(1,2,3)[5]+'sh/ ';
                    ...
                    lineByLine16.innerHTML=linesArray[3][5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])]+' '+linesArray[3][1+5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])]+'<br>'+linesArray[4][5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])]+' '+linesArray[4][1+5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])]+
                    '<br>'+linesArray[5][5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])]+' '+linesArray[5][1+5*lineNumber(1,finalLineup[3][6],finalLineup[3][7],finalLineup[3][8])];
                    ...
                    fourthLineTime3Away.innerHTML=lineByLine(1,3,0)[0]+'s '+lineByLine(1,3,0)[1]+'sh/ '+lineByLine(1,3,1)[0]+'s '+lineByLine(1,3,1)[1]+'sh/ '+lineByLine(1,3,2)[0]+'s '+lineByLine(1,3,2)[1]+'sh/ '+lineByLine(1,3,3)[0]+'s '+lineByLine(1,3,3)[1]+'sh/ '+'<br>'+lineByLine(1,3,0)[2]+'s '+lineByLine(1,3,0)[3]+'sh/ '+lineByLine(1,3,1)[2]+'s '+lineByLine(1,3,1)[3]+'sh/ '+
                    lineByLine(1,3,2)[2]+'s '+lineByLine(1,3,2)[3]+'sh/ '+lineByLine(1,3,3)[2]+'s '+lineByLine(1,3,3)[3]+'sh/ '+'<br>'+lineByLine(1,3,0)[4]+'s '+lineByLine(1,3,0)[5]+'sh/ '+lineByLine(1,3,1)[4]+'s '+lineByLine(1,3,1)[5]+'sh/ '+lineByLine(1,3,2)[4]+'s '+lineByLine(1,3,2)[5]+'sh/ '+lineByLine(1,3,3)[4]+'s '+lineByLine(1,3,3)[5]+'sh/ ';
                    ...
                    lineByLine17.innerHTML=linesArray[3][5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+' '+linesArray[3][1+5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+'<br>'+linesArray[4][5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+' '+linesArray[4][1+5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+
                    '<br>'+linesArray[5][5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+' '+linesArray[5][1+5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])];
                  }
                       ...
                       function lineByLine2x(h,f,j) { shiftsLine=[]; for (i=0;i<16;i++) {shiftsLine.push([])}
