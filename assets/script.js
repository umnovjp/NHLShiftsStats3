      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    firstLineTime3Away.innerHTML=lineByLine(1,0,0)[0]+'s '+lineByLine(1,0,0)[1]+'sh/ '+lineByLine(1,0,0)[2]+'s '+lineByLine(1,0,0)[3]+'sh/ '+lineByLine(1,0,0)[4]+'s '+lineByLine(1,0,0)[5]+'sh/ '+'<br>'+lineByLine(1,0,1)[0]+'s '+lineByLine(1,0,1)[1]+'sh/ '+lineByLine(1,0,1)[2]+'s '+lineByLine(1,0,1)[3]+'sh/ '+lineByLine(1,0,1)[4]+'s '+lineByLine(1,0,1)[5]+'sh/ '+'<br>'+
                    lineByLine(1,0,2)[0]+'s '+lineByLine(1,0,2)[1]+'sh/ '+lineByLine(1,0,2)[2]+'s '+lineByLine(1,0,2)[3]+'sh/ '+lineByLine(1,0,2)[3]+'sh/ '+lineByLine(1,0,2)[4]+'s '+lineByLine(1,0,2)[5]+'sh/ '+'<br>'+lineByLine(1,0,3)[0]+'s '+lineByLine(1,0,3)[1]+'sh/ '+lineByLine(1,0,3)[2]+'s '+lineByLine(1,0,3)[3]+'sh/ '+lineByLine(1,0,3)[4]+'s '+lineByLine(1,0,3)[5]+'sh/ ';
                    ...
                    secondLineTime3Away.innerHTML=lineByLine(1,1,0)[0]+'s '+lineByLine(1,1,0)[1]+'sh/ '+lineByLine(1,1,0)[2]+'s '+lineByLine(1,1,0)[3]+'sh/ '+lineByLine(1,1,0)[4]+'s '+lineByLine(1,1,0)[5]+'sh/ '+'<br>'+lineByLine(1,1,1)[0]+'s'+lineByLine(1,1,1)[1]+'sh/ '+lineByLine(1,1,1)[2]+'s '+lineByLine(1,1,1)[3]+'sh/ '+lineByLine(1,1,1)[4]+'s '+lineByLine(1,1,1)[5]+'sh/ '+'<br>'+
                    lineByLine(1,1,2)[0]+'s '+lineByLine(1,1,2)[1]+'sh/ '+lineByLine(1,1,2)[2]+'s '+lineByLine(1,1,2)[3]+'sh/ '+lineByLine(1,1,2)[3]+'sh/ '+lineByLine(1,1,2)[4]+'s '+lineByLine(1,1,2)[5]+'sh/ '+'<br>'+lineByLine(1,1,3)[0]+'s '+lineByLine(1,1,3)[1]+'sh/ '+lineByLine(1,1,3)[2]+'s '+lineByLine(1,1,3)[3]+'sh/ '+lineByLine(1,1,3)[4]+'s '+lineByLine(1,1,3)[5]+'sh/ ';
                    ...
                    thirdLineTime3Away.innerHTML=lineByLine(1,2,0)[0]+'s '+lineByLine(1,2,0)[1]+'sh/ '+lineByLine(1,2,0)[2]+'s '+lineByLine(1,2,0)[3]+'sh/ '+lineByLine(1,2,0)[4]+'s '+lineByLine(1,2,0)[5]+'sh/ '+'<br>'+lineByLine(1,2,1)[0]+'s'+lineByLine(1,2,1)[1]+'sh/ '+lineByLine(1,2,1)[2]+'s '+lineByLine(1,2,1)[3]+'sh/ '+lineByLine(1,2,1)[4]+'s '+lineByLine(1,2,1)[5]+'sh/ '+'<br>'+
                    lineByLine(1,2,2)[0]+'s '+lineByLine(1,2,2)[1]+'sh/ '+lineByLine(1,2,2)[2]+'s '+lineByLine(1,2,2)[3]+'sh/ '+lineByLine(1,2,2)[3]+'sh/ '+lineByLine(1,2,2)[4]+'s '+lineByLine(1,2,2)[5]+'sh/ '+'<br>'+lineByLine(1,2,3)[0]+'s '+lineByLine(1,2,3)[1]+'sh/ '+lineByLine(1,2,3)[2]+'s '+lineByLine(1,2,3)[3]+'sh/ '+lineByLine(1,2,3)[4]+'s '+lineByLine(1,2,3)[5]+'sh/ ';
                    ...
                    fourthLineTime3Away.innerHTML=lineByLine(1,3,0)[0]+'s '+lineByLine(1,3,0)[1]+'sh/ '+lineByLine(1,3,0)[2]+'s '+lineByLine(1,3,0)[3]+'sh/ '+lineByLine(1,3,0)[4]+'s '+lineByLine(1,3,0)[5]+'sh/ '+'<br>'+lineByLine(1,3,1)[0]+'s'+lineByLine(1,3,1)[1]+'sh/ '+lineByLine(1,3,1)[2]+'s '+lineByLine(1,3,1)[3]+'sh/ '+lineByLine(1,3,1)[4]+'s '+lineByLine(1,3,1)[5]+'sh/ '+'<br>'+
                    lineByLine(1,3,2)[0]+'s '+lineByLine(1,3,2)[1]+'sh/ '+lineByLine(1,3,2)[2]+'s '+lineByLine(1,3,2)[3]+'sh/ '+lineByLine(1,3,2)[3]+'sh/ '+lineByLine(1,3,2)[4]+'s '+lineByLine(1,3,2)[5]+'sh/ '+'<br>'+lineByLine(1,3,3)[0]+'s '+lineByLine(1,3,3)[1]+'sh/ '+lineByLine(1,3,3)[2]+'s '+lineByLine(1,3,3)[3]+'sh/ '+lineByLine(1,3,3)[4]+'s '+lineByLine(1,3,3)[5]+'sh/ '}
