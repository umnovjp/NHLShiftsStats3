      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  //   shiftsLine[13][2].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    lineByLine36.innerHTML=lineByLine(0,1,2)[0][0]+' '+lineByLine(0,1,2)[0][1]+' '+lineByLine(1,2,1)[0][0]+' '+lineByLine(1,2,1)[0][1]+' '+'<br>'+lineByLine(0,1,2)[0][2]+' '+lineByLine(0,1,2)[0][3]+' '+lineByLine(1,2,1)[0][2]+' '+lineByLine(1,2,1)[0][3]+' '+'<br>'+lineByLine(0,1,2)[0][4]+' '+lineByLine(0,1,2)[0][5]+' '+lineByLine(1,2,1)[0][4]+' '+lineByLine(1,2,1)[0][5]+' ';
                    lineByLine37.innerHTML=lineByLine(0,1,3)[0][0]+' '+lineByLine(0,1,3)[0][1]+' '+lineByLine(1,3,1)[0][0]+' '+lineByLine(1,3,1)[0][1]+' '+'<br>'+lineByLine(0,1,3)[0][2]+' '+lineByLine(0,1,3)[0][3]+' '+lineByLine(1,3,1)[0][2]+' '+lineByLine(1,3,1)[0][3]+' '+'<br>'+lineByLine(0,1,3)[0][4]+' '+lineByLine(0,1,3)[0][5]+' '+lineByLine(1,3,1)[0][4]+' '+lineByLine(1,3,1)[0][5]+' ';
                    ...
                    lineByLine44.innerHTML=lineByLine(0,2,0)[0][0]+' '+lineByLine(0,2,0)[0][1]+' '+lineByLine(1,0,2)[0][0]+' '+lineByLine(1,0,2)[0][1]+' '+'<br>'+lineByLine(0,2,0)[0][2]+' '+lineByLine(0,2,0)[0][3]+' '+lineByLine(1,2,0)[0][2]+' '+lineByLine(1,2,0)[0][3]+' '+'<br>'+lineByLine(0,2,0)[0][4]+' '+lineByLine(0,2,0)[0][5]+' '+lineByLine(1,0,2)[0][4]+' '+lineByLine(1,0,2)[0][5]+' ';
                    lineByLine45.innerHTML=lineByLine(0,2,1)[0][0]+' '+lineByLine(0,2,1)[0][1]+' '+lineByLine(1,1,2)[0][0]+' '+lineByLine(1,1,2)[0][1]+' '+'<br>'+lineByLine(0,2,1)[0][2]+' '+lineByLine(0,2,1)[0][3]+' '+lineByLine(1,2,1)[0][2]+' '+lineByLine(1,2,1)[0][3]+' '+'<br>'+lineByLine(0,2,1)[0][4]+' '+lineByLine(0,2,1)[0][5]+' '+lineByLine(1,1,2)[0][4]+' '+lineByLine(1,1,2)[0][5]+' ';
                    ...
                    lineByLine47.innerHTML=lineByLine(0,2,3)[0][0]+' '+lineByLine(0,2,3)[0][1]+' '+lineByLine(1,3,2)[0][0]+' '+lineByLine(1,3,2)[0][1]+' '+'<br>'+lineByLine(0,2,3)[0][2]+' '+lineByLine(0,2,3)[0][3]+' '+lineByLine(1,3,2)[0][2]+' '+lineByLine(1,3,2)[0][3]+' '+'<br>'+lineByLine(0,2,3)[0][4]+' '+lineByLine(0,2,3)[0][5]+' '+lineByLine(1,3,2)[0][4]+' '+lineByLine(1,3,2)[0][5]+' ';
                    ...
                    lineByLine54.innerHTML=lineByLine(0,3,0)[0][0]+' '+lineByLine(0,3,0)[0][1]+' '+lineByLine(1,0,3)[0][0]+' '+lineByLine(1,0,3)[0][1]+' '+'<br>'+lineByLine(0,3,0)[0][2]+' '+lineByLine(0,3,0)[0][3]+' '+lineByLine(1,0,3)[0][2]+' '+lineByLine(1,0,3)[0][3]+' '+'<br>'+lineByLine(0,3,0)[0][4]+' '+lineByLine(0,3,0)[0][5]+' '+lineByLine(1,0,3)[0][4]+' '+lineByLine(1,0,3)[0][5]+' ';
                    lineByLine55.innerHTML=lineByLine(0,3,1)[0][0]+' '+lineByLine(0,3,1)[0][1]+' '+lineByLine(1,1,3)[0][0]+' '+lineByLine(1,1,3)[0][1]+' '+'<br>'+lineByLine(0,3,1)[0][2]+' '+lineByLine(0,3,1)[0][3]+' '+lineByLine(1,1,3)[0][2]+' '+lineByLine(1,1,3)[0][3]+' '+'<br>'+lineByLine(0,3,1)[0][4]+' '+lineByLine(0,3,1)[0][5]+' '+lineByLine(1,1,3)[0][4]+' '+lineByLine(1,1,3)[0][5]+' ';
                    lineByLine56.innerHTML=lineByLine(0,3,2)[0][0]+' '+lineByLine(0,3,2)[0][1]+' '+lineByLine(1,2,3)[0][0]+' '+lineByLine(1,2,3)[0][1]+' '+'<br>'+lineByLine(0,3,2)[0][2]+' '+lineByLine(0,3,2)[0][3]+' '+lineByLine(1,2,3)[0][2]+' '+lineByLine(1,2,3)[0][3]+' '+'<br>'+lineByLine(0,3,2)[0][4]+' '+lineByLine(0,3,2)[0][5]+' '+lineByLine(1,2,3)[0][4]+' '+lineByLine(1,2,3)[0][5]+' ';
