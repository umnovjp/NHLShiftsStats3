      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    lineByLine25.innerHTML=lineByLine(0,0,1)[0]+'s '+lineByLine(0,0,1)[1]+'sh/ '+'<br>'+lineByLine(0,0,1)[2]+'s '+lineByLine(0,0,1)[3]+'sh/ '
                    +'<br>'+lineByLine(0,0,1)[4]+'s '+lineByLine(0,0,1)[5]+'sh/ ';
                    lineByLine26.innerHTML=lineByLine(0,0,2)[0]+'s '+lineByLine(0,0,2)[1]+'sh/ '+'<br>'+
                    lineByLine(0,0,2)[2]+'s '+lineByLine(0,0,2)[3]+'sh/ '+'<br>'+lineByLine(0,0,2)[4]+'s '+lineByLine(0,0,2)[5]+'sh/ ';
                    lineByLine27.innerHTML=lineByLine(0,0,3)[0]+'s '+lineByLine(0,0,3)[1]+'sh/ '+'<br>'+
                    lineByLine(0,0,3)[2]+'s '+lineByLine(0,0,3)[3]+'sh/ '+'<br>'+lineByLine(0,0,3)[4]+'s '+lineByLine(0,0,3)[5]+'sh/ ';
