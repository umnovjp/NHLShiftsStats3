...
## Known Failures
Some game data are not displayed correctly because of obvious errors in NHL databases. Example is STL at FLA game on 12/21/2023 where data for many shifts are duplicated in database. 
