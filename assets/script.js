      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    lineByLine00.innerHTML = homeF[1+3*finalLineup[2][0]]+' '+homeF[2+3*finalLineup[2][0]]+'<br>'+homeF[1+3*finalLineup[2][1]]+' '+homeF[2+3*finalLineup[2][1]]+'<br>'+homeF[1+3*finalLineup[2][2]]+' '+homeF[2+3*finalLineup[2][2]];
                    ...
                    // secondLineTime3.innerHTML=lineByLine(0,1,0)[0]+'s '+lineByLine(0,1,0)[1]+'sh/ '+lineByLine(0,1,0)[2]+'s '+lineByLine(0,1,0)[3]+'sh/ '+lineByLine(0,1,0)[4]+'s '+lineByLine(0,1,0)[5]+'sh/ '+'<br>'+lineByLine(0,1,1)[0]+'s'+lineByLine(0,1,1)[1]+'sh/ '+lineByLine(0,1,1)[2]+'s '+lineByLine(0,1,1)[3]+'sh/ '+lineByLine(0,1,1)[4]+'s '+lineByLine(0,1,1)[5]+'sh/ '+'<br>'+
                    ...
                    lineByLine01.innerHTML=homeF[1+3*finalLineup[2][3]]+' '+homeF[2+3*finalLineup[2][3]]+'<br>'+homeF[1+3*finalLineup[2][4]]+' '+homeF[2+3*finalLineup[2][4]]+'<br>'+homeF[1+3*finalLineup[2][5]]+' '+homeF[2+3*finalLineup[2][5]];
                    ...
                    lineByLine02.innerHTML=homeF[1+3*finalLineup[2][6]]+' '+homeF[2+3*finalLineup[2][6]]+'<br>'+homeF[1+3*finalLineup[2][7]]+' '+homeF[2+3*finalLineup[2][7]]+'<br>'+homeF[1+3*finalLineup[2][8]]+' '+homeF[2+3*finalLineup[2][8]];
                    ...
                    lineByLine03.innerHTML=fourthLine.innerHTML=homeF[1+3*finalLineup[2][9]]+' '+homeF[2+3*finalLineup[2][9]]+'<br>'+homeF[1+3*finalLineup[2][10]]+' '+homeF[2+3*finalLineup[2][10]]+'<br>'+homeF[1+3*finalLineup[2][11]]+' '+homeF[2+3*finalLineup[2][11]];
                  }
                    ...
                    lineByLine03.innerHTML=homeF[1+3*finalLineup[2][9]]+' '+homeF[2+3*finalLineup[2][9]]+'<br>'+homeF[1+3*finalLineup[2][10]]+' '+homeF[2+3*finalLineup[2][10]]
                  }
                    lineByLine10.innerHTML=awayF[1+3*finalLineup[3][0]]+' '+awayF[2+3*finalLineup[3][0]]+'<br>'+awayF[1+3*finalLineup[3][1]]+' '+awayF[2+3*finalLineup[3][1]]+'<br>'+awayF[1+3*finalLineup[3][2]]+' '+awayF[2+3*finalLineup[3][2]];
