    ...
    .then(function (data) {console.log('I am in schedule then');
      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  lineVsLineTime=0; lineVsLineShifts=0; // shiftsLine[13].push([])
                  ...
                  for (k=0;k<shiftsLine[9+i].length/2;k++) { lineVsLineTime=lineVsLineTime+shiftsLine[9+i][2*k+1]-shiftsLine[9+i][2*k];
                    ...
                    shiftsLine[13][2].push(lineVsLineTime, lineVsLineShifts)
                  } // end i loop
                    ...
                    lineByLine26.innerHTML=lineByLine(0,0,2)[0][0]+' '+lineByLine(0,0,2)[0][1]+' '+lineByLine(1,2,0)[0][0]+' '+lineByLine(1,2,0)[0][1]+' '+'<br>'+lineByLine(0,0,2)[0][2]+' '+lineByLine(0,0,2)[0][3]+' '+lineByLine(1,2,0)[0][2]+' '+lineByLine(1,2,0)[0][3]+' '+'<br>'+lineByLine(0,0,2)[0][4]+' '+lineByLine(0,0,2)[0][5]+' '+lineByLine(1,2,0)[0][4]+' '+lineByLine(1,2,0)[0][5]+' ';
                    lineByLine27.innerHTML=lineByLine(0,0,3)[0][0]+' '+lineByLine(0,0,3)[0][1]+' '+lineByLine(1,3,0)[0][0]+' '+lineByLine(1,3,0)[0][1]+' '+'<br>'+lineByLine(0,0,3)[0][2]+' '+lineByLine(0,0,3)[0][3]+' '+lineByLine(1,3,0)[0][2]+' '+lineByLine(1,3,0)[0][3]+' '+'<br>'+lineByLine(0,0,3)[0][4]+' '+lineByLine(0,0,3)[0][5]+' '+lineByLine(1,3,0)[0][4]+' '+lineByLine(1,3,0)[0][5]+' ';
                    ...
                    secondLineTime3.innerHTML=lineByLine(0,1,0)[0][0]+' '+lineByLine(0,1,0)[0][1]+' '+lineByLine(0,1,1)[0][0]+' '+lineByLine(0,1,1)[0][1]+' '+lineByLine(0,1,2)[0][0]+' '+lineByLine(0,1,2)[0][1]+' '+lineByLine(0,1,3)[0][0]+' '+lineByLine(0,1,3)[0][1]+' '+'<br>'+lineByLine(0,1,0)[0][2]+' '+lineByLine(0,1,0)[0][3]+' '+lineByLine(0,1,1)[0][2]+' '+lineByLine(0,1,1)[0][3]+' '+
                    ...
                    lineByLine34.innerHTML=lineByLine(0,1,0)[0][0]+' '+lineByLine(0,1,0)[0][1]+' '+lineByLine(1,0,1)[0][0]+' '+lineByLine(1,0,1)[0][1]+' '+'<br>'+lineByLine(0,1,0)[0][2]+' '+lineByLine(0,1,0)[0][3]+' '+lineByLine(1,0,1)[0][2]+' '+lineByLine(1,0,1)[0][3]+' '+'<br>'+lineByLine(0,1,0)[0][4]+' '+lineByLine(0,1,0)[0][5]+' '+lineByLine(1,0,1)[0][4]+' '+lineByLine(1,0,1)[0][5]+' ';
                    lineByLine35.innerHTML=lineByLine(0,1,1)[0][0]+' '+lineByLine(0,1,1)[0][1]+' '+lineByLine(1,1,1)[0][0]+' '+lineByLine(1,1,1)[0][1]+' '+'<br>'+lineByLine(0,1,1)[0][2]+' '+lineByLine(0,1,1)[0][3]+' '+lineByLine(1,1,1)[0][2]+' '+lineByLine(1,1,1)[0][3]+' '+'<br>'+lineByLine(0,1,1)[0][4]+' '+lineByLine(0,1,1)[0][5]+' '+lineByLine(1,1,1)[0][4]+' '+lineByLine(1,1,1)[0][5]+' ';
                    lineByLine36.innerHTML=lineByLine(0,1,2)[0][0]+' '+lineByLine(0,1,2)[0][1]+' '+lineByLine(1,1,2)[0][0]+' '+lineByLine(1,1,2)[0][1]+' '+'<br>'+lineByLine(0,1,2)[0][2]+' '+lineByLine(0,1,2)[0][3]+' '+lineByLine(1,1,2)[0][2]+' '+lineByLine(1,1,2)[0][3]+' '+'<br>'+lineByLine(0,1,2)[0][4]+' '+lineByLine(0,1,2)[0][5]+' '+lineByLine(1,1,2)[0][4]+' '+lineByLine(1,1,2)[0][5]+' ';
                    lineByLine37.innerHTML=lineByLine(0,1,3)[0][0]+' '+lineByLine(0,1,3)[0][1]+' '+lineByLine(1,1,3)[0][0]+' '+lineByLine(1,1,3)[0][1]+' '+'<br>'+lineByLine(0,1,3)[0][2]+' '+lineByLine(0,1,3)[0][3]+' '+lineByLine(1,1,3)[0][2]+' '+lineByLine(1,1,3)[0][3]+' '+'<br>'+lineByLine(0,1,3)[0][4]+' '+lineByLine(0,1,3)[0][5]+' '+lineByLine(1,1,3)[0][4]+' '+lineByLine(1,1,3)[0][5]+' ';
                    ...
                    thirdLineTime3.innerHTML=lineByLine(0,2,0)[0][0]+' '+lineByLine(0,2,0)[0][1]+' '+lineByLine(0,2,1)[0][0]+' '+lineByLine(0,2,1)[0][1]+' '+lineByLine(0,2,2)[0][0]+' '+lineByLine(0,2,2)[0][1]+' '+lineByLine(0,2,3)[0][0]+' '+lineByLine(0,2,3)[0][1]+' '+'<br>'+lineByLine(0,2,0)[0][2]+' '+lineByLine(0,2,0)[0][3]+' '+lineByLine(0,2,1)[0][2]+' '+lineByLine(0,2,1)[0][3]+' '+
                    ...
                    lineByLine44.innerHTML=lineByLine(0,2,0)[0][0]+' '+lineByLine(0,2,0)[0][1]+' '+lineByLine(1,2,0)[0][0]+' '+lineByLine(1,2,0)[0][1]+' '+'<br>'+lineByLine(0,2,0)[0][2]+' '+lineByLine(0,2,0)[0][3]+' '+lineByLine(1,2,0)[0][2]+' '+lineByLine(1,2,0)[0][3]+' '+'<br>'+lineByLine(0,2,0)[0][4]+' '+lineByLine(0,2,0)[0][5]+' '+lineByLine(1,2,0)[0][4]+' '+lineByLine(1,2,0)[0][5]+' ';
                    lineByLine45.innerHTML=lineByLine(0,2,1)[0][0]+' '+lineByLine(0,2,1)[0][1]+' '+lineByLine(1,2,1)[0][0]+' '+lineByLine(1,2,1)[0][1]+' '+'<br>'+lineByLine(0,2,1)[0][2]+' '+lineByLine(0,2,1)[0][3]+' '+lineByLine(1,2,1)[0][2]+' '+lineByLine(1,2,1)[0][3]+' '+'<br>'+lineByLine(0,2,1)[0][4]+' '+lineByLine(0,2,1)[0][5]+' '+lineByLine(1,2,1)[0][4]+' '+lineByLine(1,2,1)[0][5]+' ';
                    lineByLine46.innerHTML=lineByLine(0,2,2)[0][0]+' '+lineByLine(0,2,2)[0][1]+' '+lineByLine(1,2,2)[0][0]+' '+lineByLine(1,2,2)[0][1]+' '+'<br>'+lineByLine(0,2,2)[0][2]+' '+lineByLine(0,2,2)[0][3]+' '+lineByLine(1,2,2)[0][2]+' '+lineByLine(1,2,2)[0][3]+' '+'<br>'+lineByLine(0,2,2)[0][4]+' '+lineByLine(0,2,2)[0][5]+' '+lineByLine(1,2,2)[0][4]+' '+lineByLine(1,2,2)[0][5]+' ';
                    lineByLine47.innerHTML=lineByLine(0,2,3)[0][0]+' '+lineByLine(0,2,3)[0][1]+' '+lineByLine(1,2,3)[0][0]+' '+lineByLine(1,2,3)[0][1]+' '+'<br>'+lineByLine(0,2,3)[0][2]+' '+lineByLine(0,2,3)[0][3]+' '+lineByLine(1,2,3)[0][2]+' '+lineByLine(1,2,3)[0][3]+' '+'<br>'+lineByLine(0,2,3)[0][4]+' '+lineByLine(0,2,3)[0][5]+' '+lineByLine(1,2,3)[0][4]+' '+lineByLine(1,2,3)[0][5]+' ';
                    ...
                    fourthLineTime3.innerHTML=lineByLine(0,3,0)[0][0]+' '+lineByLine(0,3,0)[0][1]+' '+lineByLine(0,3,1)[0][0]+' '+lineByLine(0,3,1)[0][1]+' '+lineByLine(0,3,2)[0][0]+' '+lineByLine(0,3,2)[0][1]+' '+lineByLine(0,3,3)[0][0]+' '+lineByLine(0,3,3)[0][1]+' '+'<br>'+lineByLine(0,3,0)[0][2]+' '+lineByLine(0,3,0)[0][3]+' '+lineByLine(0,3,1)[0][2]+' '+lineByLine(0,3,1)[0][3]+' '+
                    ...
                    lineByLine54.innerHTML=lineByLine(0,3,0)[0][0]+' '+lineByLine(0,3,0)[0][1]+' '+lineByLine(1,3,0)[0][0]+' '+lineByLine(1,3,0)[0][1]+' '+'<br>'+lineByLine(0,3,0)[0][2]+' '+lineByLine(0,3,0)[0][3]+' '+lineByLine(1,3,0)[0][2]+' '+lineByLine(1,3,0)[0][3]+' '+'<br>'+lineByLine(0,3,0)[0][4]+' '+lineByLine(0,3,0)[0][5]+' '+lineByLine(1,3,0)[0][4]+' '+lineByLine(1,3,0)[0][5]+' ';
                    lineByLine55.innerHTML=lineByLine(0,3,1)[0][0]+' '+lineByLine(0,3,1)[0][1]+' '+lineByLine(1,3,1)[0][0]+' '+lineByLine(1,3,1)[0][1]+' '+'<br>'+lineByLine(0,3,1)[0][2]+' '+lineByLine(0,3,1)[0][3]+' '+lineByLine(1,3,1)[0][2]+' '+lineByLine(1,3,1)[0][3]+' '+'<br>'+lineByLine(0,3,1)[0][4]+' '+lineByLine(0,3,1)[0][5]+' '+lineByLine(1,3,1)[0][4]+' '+lineByLine(1,3,1)[0][5]+' ';
                    lineByLine56.innerHTML=lineByLine(0,3,2)[0][0]+' '+lineByLine(0,3,2)[0][1]+' '+lineByLine(1,3,2)[0][0]+' '+lineByLine(1,3,2)[0][1]+' '+'<br>'+lineByLine(0,3,2)[0][2]+' '+lineByLine(0,3,2)[0][3]+' '+lineByLine(1,3,2)[0][2]+' '+lineByLine(1,3,2)[0][3]+' '+'<br>'+lineByLine(0,3,2)[0][4]+' '+lineByLine(0,3,2)[0][5]+' '+lineByLine(1,3,2)[0][4]+' '+lineByLine(1,3,2)[0][5]+' ';
                    lineByLine57.innerHTML=lineByLine(0,3,3)[0][0]+' '+lineByLine(0,3,3)[0][1]+' '+lineByLine(1,3,3)[0][0]+' '+lineByLine(1,3,3)[0][1]+' '+'<br>'+lineByLine(0,3,3)[0][2]+' '+lineByLine(0,3,3)[0][3]+' '+lineByLine(1,3,3)[0][2]+' '+lineByLine(1,3,3)[0][3]+' '+'<br>'+lineByLine(0,3,3)[0][4]+' '+lineByLine(0,3,3)[0][5]+' '+lineByLine(1,3,3)[0][4]+' '+lineByLine(1,3,3)[0][5]+' ';
                  }
                    ...
                    secondLineTime3Away.innerHTML=lineByLine(1,1,0)[0][0]+'s '+lineByLine(1,1,0)[0][1]+'sh/ '+lineByLine(1,1,1)[0][0]+'s '+lineByLine(1,1,1)[0][1]+'sh/ '+lineByLine(1,1,2)[0][0]+'s '+lineByLine(1,1,2)[0][1]+'sh/ '+lineByLine(1,1,3)[0][0]+'s '+lineByLine(1,1,3)[0][1]+'sh/ '+'<br>'+lineByLine(1,1,0)[0][2]+'s '+lineByLine(1,1,0)[0][3]+'sh/ '+lineByLine(1,1,1)[0][2]+'s '+lineByLine(1,1,1)[0][3]+'sh/ '+
                    lineByLine(1,1,2)[0][2]+'s '+lineByLine(1,1,2)[0][3]+'sh/ '+lineByLine(1,1,3)[0][2]+'s '+lineByLine(1,1,3)[0][3]+'sh/ '+'<br>'+lineByLine(1,1,0)[0][4]+'s '+lineByLine(1,1,0)[0][5]+'sh/ '+lineByLine(1,1,1)[0][4]+'s '+lineByLine(1,1,1)[0][5]+'sh/ '+lineByLine(1,1,2)[0][4]+'s '+lineByLine(1,1,2)[0][5]+'sh/ '+lineByLine(1,1,3)[0][4]+'s '+lineByLine(1,1,3)[0][5]+'sh/ ';
                    ...
                    thirdLineTime3Away.innerHTML=lineByLine(1,2,0)[0][0]+'s '+lineByLine(1,2,0)[0][1]+'sh/ '+lineByLine(1,2,1)[0][0]+'s '+lineByLine(1,2,1)[0][1]+'sh/ '+lineByLine(1,2,2)[0][0]+'s '+lineByLine(1,2,2)[0][1]+'sh/ '+lineByLine(1,2,3)[0][0]+'s '+lineByLine(1,2,3)[0][1]+'sh/ '+'<br>'+lineByLine(1,2,0)[0][2]+'s '+lineByLine(1,2,0)[0][3]+'sh/ '+lineByLine(1,2,1)[0][2]+'s '+lineByLine(1,2,1)[0][3]+'sh/ '+
                    lineByLine(1,2,2)[0][2]+'s '+lineByLine(1,2,2)[0][3]+'sh/ '+lineByLine(1,2,3)[0][2]+'s '+lineByLine(1,2,3)[0][3]+'sh/ '+'<br>'+lineByLine(1,2,0)[0][4]+'s '+lineByLine(1,2,0)[0][5]+'sh/ '+lineByLine(1,2,1)[0][4]+'s '+lineByLine(1,2,1)[0][5]+'sh/ '+lineByLine(1,2,2)[0][4]+'s '+lineByLine(1,2,2)[0][5]+'sh/ '+lineByLine(1,2,3)[0][4]+'s '+lineByLine(1,2,3)[0][5]+'sh/ ';
                    ...
                    fourthLineTime3Away.innerHTML=lineByLine(1,3,0)[0][0]+'s '+lineByLine(1,3,0)[0][1]+'sh/ '+lineByLine(1,3,1)[0][0]+'s '+lineByLine(1,3,1)[0][1]+'sh/ '+lineByLine(1,3,2)[0][0]+'s '+lineByLine(1,3,2)[0][1]+'sh/ '+lineByLine(1,3,3)[0][0]+'s '+lineByLine(1,3,3)[0][1]+'sh/ '+'<br>'+lineByLine(1,3,0)[0][2]+'s '+lineByLine(1,3,0)[0][3]+'sh/ '+lineByLine(1,3,1)[0][2]+'s '+lineByLine(1,3,1)[0][3]+'sh/ '+
                    lineByLine(1,3,2)[0][2]+'s '+lineByLine(1,3,2)[0][3]+'sh/ '+lineByLine(1,3,3)[0][2]+'s '+lineByLine(1,3,3)[0][3]+'sh/ '+'<br>'+lineByLine(1,3,0)[0][4]+'s '+lineByLine(1,3,0)[0][5]+'sh/ '+lineByLine(1,3,1)[0][4]+'s '+lineByLine(1,3,1)[0][5]+'sh/ '+lineByLine(1,3,2)[0][4]+'s '+lineByLine(1,3,2)[0][5]+'sh/ '+lineByLine(1,3,3)[0][4]+'s '+lineByLine(1,3,3)[0][5]+'sh/ ';
                    ...
                    '<br>'+linesArray[5][5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])]+' '+linesArray[5][1+5*lineNumber(1,finalLineup[3][9],finalLineup[3][10],finalLineup[3][11])];
                       ...
                       function lineByLine2x(h,f,j) { shiftsLine=[]; for (i=0;i<14;i++) {shiftsLine.push([])} shiftsLine[13]=[[],[],[]]
