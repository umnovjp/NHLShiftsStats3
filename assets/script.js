      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                    ...
                    for (l=0;l<shiftsLine[3+i].length/2;l++) {for (m=0;m<shiftsLine[9+i].length/2;m++) {if ((shiftsLine[9+i][2*m]>=shiftsLine[3+i][2*l])&&(shiftsLine[9+i][2*m]<=shiftsLine[3+i][2*l+1])){
                      if ((shiftsLine[9+i][2*m]>=m<shiftsLine[3+i][2*l]) && (shiftsLine[9+i][2*m]<=m<shiftsLine[9+i][2*l+1])) {if (shiftsLine[3+i][2*m+1]>=shiftsLine[9+i][2*l+1]){shiftsLine[12][i].push(shiftsLine[9+i][2*m], shiftsLine[3+i][2*l+1])}
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    secondLineTime3.innerHTML=lineByLine(0,1,0)[0]+'s '+lineByLine(0,1,0)[1]+'sh/ '+lineByLine(0,1,1)[0]+'s '+lineByLine(0,1,1)[1]+'sh/ '+lineByLine(0,1,2)[0]+'s '+lineByLine(0,1,2)[1]+'sh/ '+lineByLine(0,1,3)[0]+'s '+lineByLine(0,1,3)[1]+'sh/ '+'<br>'+lineByLine(0,1,0)[2]+'s '+lineByLine(0,1,0)[3]+'sh/ '+lineByLine(0,1,1)[2]+'s '+lineByLine(0,1,1)[3]+'sh/ '+
                    lineByLine(0,1,2)[2]+'s '+lineByLine(0,1,2)[3]+'sh/ '+lineByLine(0,1,3)[2]+'s '+lineByLine(0,1,3)[3]+'sh/ '+'<br>'+lineByLine(0,1,0)[4]+'s '+lineByLine(0,1,0)[5]+'sh/ '+lineByLine(0,1,1)[4]+'s '+lineByLine(0,1,1)[5]+'sh/ '+lineByLine(0,1,2)[4]+'s '+lineByLine(0,1,2)[5]+'sh/ '+lineByLine(0,1,3)[4]+'s '+lineByLine(0,1,3)[5]+'sh/ ';
                    ...
                    firstLineTime3Away.innerHTML=lineByLine(1,0,0)[0]+'s '+lineByLine(1,0,0)[1]+'sh/ '+lineByLine(1,0,1)[0]+'s '+lineByLine(1,0,1)[1]+'sh/ '+lineByLine(1,0,2)[0]+'s '+lineByLine(1,0,2)[1]+'sh/ '+lineByLine(1,0,3)[0]+'s '+lineByLine(1,0,3)[1]+'sh/ '+'<br>'+lineByLine(1,0,0)[2]+'s '+lineByLine(1,0,0)[3]+'sh/ '+lineByLine(1,0,1)[2]+'s '+lineByLine(1,0,1)[3]+'sh/ '+
                    lineByLine(1,0,2)[2]+'s '+lineByLine(1,0,2)[3]+'sh/ '+lineByLine(1,0,3)[2]+'s '+lineByLine(1,0,3)[3]+'sh/ '+'<br>'+lineByLine(1,0,0)[4]+'s '+lineByLine(1,0,0)[5]+'sh/ '+lineByLine(1,0,1)[4]+'s '+lineByLine(1,0,1)[5]+'sh/ '+lineByLine(1,0,2)[4]+'s '+lineByLine(1,0,2)[5]+'sh/ '+lineByLine(1,0,3)[4]+'s '+lineByLine(1,0,3)[5]+'sh/ ';
