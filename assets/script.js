      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    lineByLine46.innerHTML=lineByLine(0,2,2)[0]+'s '+lineByLine(0,2,2)[1]+'sh/ '+'<br>'+lineByLine(0,2,2)[2]+'s '+lineByLine(0,2,2)[3]+'sh/ '+'<br>'+lineByLine(0,2,2)[4]+'s '+lineByLine(0,2,2)[5]+'sh/ ';
                    lineByLine47.innerHTML=lineByLine(0,2,3)[0]+'s '+lineByLine(0,2,3)[1]+'sh/ '+'<br>'+lineByLine(0,2,3)[2]+'s '+lineByLine(0,2,3)[3]+'sh/ '+'<br>'+lineByLine(0,2,3)[4]+'s '+lineByLine(0,2,3)[5]+'sh/ ';
                    ...
                    headerAway.innerHTML = 'Players'; headerAway2.innerHTML = 'TOI sec'; headerAway3.innerHTML = 'shifts'; headerAway4.innerHTML = 'shifts'; 
                    ...
                    //lineByLine00.innerHTML='00'; lineByLine02='02';
