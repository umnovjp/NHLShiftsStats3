                ...
                fetch(shiftsURL, { "method": "GET", "headers": {} })
                  ...
                  .then(function (data_shifts) {
                    ...
                    for (h = 0; h < 2; h++) { // h = 0 home team D, h = 1 away team D
                      for (i = 0; i < 3; i++) {
                        for (j = 0; j < dArray[h].length; j++) {
                          for (k = j + 1; k < dArray[h].length; k++) {
                            tempTime = [];
                    ...
                    for (i = 0; i < 2; i++) { dArrayTemp = dArray[i][0][0] // home and away teams
                      for (j = 0; j < dArray[i].length; j++) {
                        for (k = j + 1; k < dArray[i].length; k++) { dArrayTemp = dArrayTemp.concat(dArray[i][k][0]);
