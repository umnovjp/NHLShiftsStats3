      ...
      tempIndex = linesArray6[i-2].indexOf(Math.max(...linesArray6[i-2])); tempIndex2 = tempIndex%(linesArray6[i-2].length/3); 
        ...
        console.log(finalLineup, linesArray6[i-2][tempIndex+2], linesArray6[i-2][tempIndex+3], linesArray6[i-2][tempIndex+4]);
                  ...
                  shiftsLine[13].push(lineVsLineTime, lineVsLineShifts)
                    ...
                    lineByLine24.innerHTML=lineByLine(0,0,0)[0]+'s '+lineByLine(0,0,0)[1]+'sh/ '+'<br>'+lineByLine(0,0,0)[2]+'s '+lineByLine(0,0,0)[3]+'sh/ '+'<br>'+lineByLine(0,0,0)[4]+'s '+lineByLine(0,0,0)[5]+'sh/ ';
                    lineByLine25.innerHTML=lineByLine(0,0,1)[0]+'s '+lineByLine(0,0,1)[1]+'sh/ '+'<br>'+lineByLine(0,0,1)[2]+'s '+lineByLine(0,0,1)[3]+'sh/ '+'<br>'+lineByLine(0,0,1)[4]+'s '+lineByLine(0,0,1)[5]+'sh/ ';
                    lineByLine26.innerHTML=lineByLine(0,0,2)[0]+'s '+lineByLine(0,0,2)[1]+'sh/ '+'<br>'+lineByLine(0,0,2)[2]+'s '+lineByLine(0,0,2)[3]+'sh/ '+'<br>'+lineByLine(0,0,2)[4]+'s '+lineByLine(0,0,2)[5]+'sh/ ';
                    lineByLine27.innerHTML=lineByLine(0,0,3)[0]+'s '+lineByLine(0,0,3)[1]+'sh/ '+'<br>'+lineByLine(0,0,3)[2]+'s '+lineByLine(0,0,3)[3]+'sh/ '+'<br>'+lineByLine(0,0,3)[4]+'s '+lineByLine(0,0,3)[5]+'sh/ ';
                    ...
                    lineByLine34.innerHTML=lineByLine(0,1,0)[0]+'s '+lineByLine(0,1,0)[1]+'sh/ '+'<br>'+lineByLine(0,1,0)[2]+'s '+lineByLine(0,1,0)[3]+'sh/ '+'<br>'+lineByLine(0,1,0)[4]+'s '+lineByLine(0,1,0)[5]+'sh/ ';
                    lineByLine35.innerHTML=lineByLine(0,1,1)[0]+'s '+lineByLine(0,1,1)[1]+'sh/ '+'<br>'+lineByLine(0,1,1)[2]+'s '+lineByLine(0,1,1)[3]+'sh/ '+'<br>'+lineByLine(0,1,1)[4]+'s '+lineByLine(0,1,1)[5]+'sh/ ';
                    lineByLine36.innerHTML=lineByLine(0,1,2)[0]+'s '+lineByLine(0,1,2)[1]+'sh/ '+'<br>'+lineByLine(0,1,2)[2]+'s '+lineByLine(0,1,2)[3]+'sh/ '+'<br>'+lineByLine(0,1,2)[4]+'s '+lineByLine(0,1,2)[5]+'sh/ ';
                    lineByLine37.innerHTML=lineByLine(0,1,3)[0]+'s '+lineByLine(0,1,3)[1]+'sh/ '+'<br>'+lineByLine(0,1,3)[2]+'s '+lineByLine(0,1,3)[3]+'sh/ '+'<br>'+lineByLine(0,1,3)[4]+'s '+lineByLine(0,1,3)[5]+'sh/ ';
                    ...
                    lineByLine44.innerHTML=lineByLine(0,2,0)[0]+'s '+lineByLine(0,2,0)[1]+'sh/ '+'<br>'+lineByLine(0,2,0)[2]+'s '+lineByLine(0,2,0)[3]+'sh/ '+
                    '<br>'+lineByLine(0,2,0)[4]+'s '+lineByLine(0,2,0)[5]+'sh/ ';
                    lineByLine45.innerHTML=lineByLine(0,2,0)[0]+'s '+lineByLine(0,2,0)[1]+'sh/ '+lineByLine(0,2,1)[0]+'s '+lineByLine(0,2,1)[1]+'sh/ '+lineByLine(0,2,2)[0]+'s '+lineByLine(0,2,2)[1]+'sh/ '+lineByLine(0,2,3)[0]+'s '+lineByLine(0,2,3)[1]+'sh/ '+'<br>'+lineByLine(0,2,0)[2]+'s '+lineByLine(0,2,0)[3]+'sh/ '+lineByLine(0,2,1)[2]+'s '+lineByLine(0,2,1)[3]+'sh/ '+
                    lineByLine(0,2,2)[2]+'s '+lineByLine(0,2,2)[3]+'sh/ '+lineByLine(0,2,3)[2]+'s '+lineByLine(0,2,3)[3]+'sh/ '+'<br>'+lineByLine(0,2,0)[4]+'s '+lineByLine(0,2,0)[5]+'sh/ '+lineByLine(0,2,1)[4]+'s '+lineByLine(0,2,1)[5]+'sh/ '+lineByLine(0,2,2)[4]+'s '+lineByLine(0,2,2)[5]+'sh/ '+lineByLine(0,2,3)[4]+'s '+lineByLine(0,2,3)[5]+'sh/ ';
